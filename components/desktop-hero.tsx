...
export default function DesktopHero() {
  return (
    <section className="relative bg-gradient-to-r from-secondary to-secondary/80 py-16 text-white overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 p-1 rounded-2xl shadow-2xl backdrop-blur-sm">
                ...
                <Image
                  ...
                  priority // ensures LCP target is met
                />
              </div>
              {/* Rating card */}
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-4">
                ...
                >
                  <Link href="/contact" className="relative z-10">
                    <div className="absolute inset-0 w-full h-full bg-primary/20 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700" aria-hidden="true"></div>
      ...
      {/* Use Tailwind animate-spin instead of custom CSS for spinners */}
      <style jsx global>{`
        .animate-spin-slow {
