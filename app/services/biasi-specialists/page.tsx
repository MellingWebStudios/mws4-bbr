    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Biasi Specialists Birmingham - Expert Repairs & Servicing",
      }
    ],
  },
}

export default function BiasiSpecialistsPage() {
  const service = {
    id: "biasi",
  ...
  <p>Biasi boilers can present specific challenges that general heating engineers may not be familiar with. Our specialist knowledge allows us to diagnose and repair Biasi-specific issues quickly and effectively, saving you time and money.</p>
  
  <p>We stock genuine Biasi parts and can offer extended warranties on our repair work. Whether you need a simple service, a complex repair, or advice on your Biasi boiler, our specialist team is here to help.</p>
`,
    pricing: [
      {
    ...
    faqs: [
      {
        question: "Why do I need a Biasi specialist for my boiler?",
        answer:
          "Biasi boilers have unique designs and components that require specialist knowledge. Our approved technicians understand Biasi-specific issues and have access to genuine parts, ensuring more effective and lasting repairs.",
      },
      {
        question: "Do you offer warranties on Biasi boiler repairs?",
        answer:
          "Yes, we offer extended warranties on our Biasi boiler repair work, giving you peace of mind that your boiler is protected.",
      },
      {
        question: "Can you service all Biasi boiler models?",
        answer:
          "Yes, our technicians are trained to service and repair all Biasi boiler models, from older units to the latest designs.",
      },
      {
        question: "Are your Biasi boiler parts genuine?",
        answer: "Yes, we only use genuine Biasi parts to ensure the best performance and longevity of your boiler.",
      },
    ],
  }
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://www.birminghamboilerrepairs.uk/services/biasi-specialists" />
      </Head>
      <BreadcrumbSchema
        items={[
          { name: "Home", item: "https://www.birminghamboilerrepairs.uk/" },
          { name: "Services", item: "https://www.birminghamboilerrepairs.uk/services" },
          { name: "Biasi Specialists", item: "https://www.birminghamboilerrepairs.uk/services/biasi-specialists" },
        ]}
      />
      <FAQSchema faqs={service.faqs} url="https://www.birminghamboilerrepairs.uk/services/biasi-specialists" />
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-4">
                <Breadcrumb
                  items={[
                    ...
                    { label: "Biasi Specialists", href: "/services/biasi-specialists", isCurrent: true },
                  ]}
                />
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Biasi Specialists in Birmingham</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-12">
              ...
              {/* Pricing Section */}
              <div>
                <h2 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Biasi Specialist Pricing</h2>
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
              <div>
                <h2 className="text-3xl font-bold">Need help with your Biasi boiler?</h2>
