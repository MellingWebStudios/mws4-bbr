...
export const metadata: Metadata = {
  title: "Boiler Servicing Birmingham | From £60 | Gas Safe",
  description:
    "Boiler servicing in Birmingham from £60. Same-day appointments, Gas Safe engineers. Protect your warranty!",
  ...
  openGraph: {
    title: "Boiler Servicing Birmingham | From £60 | Gas Safe",
    description: "Boiler servicing in Birmingham from £60. Same-day appointments, Gas Safe engineers. Protect your warranty!",
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Professional Boiler Servicing</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-12">
              ...
              {/* Pricing Section */}
              <div>
                <h3 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Service Pricing</h3>
              ...
              <div>
                ...
                <ReviewsDisplay serviceFilter="service" limit={4} showFilters={false} showHeading={false} />
              </div>
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
              <div>
                <h3 className="text-3xl font-bold">Ready to book your boiler service?</h3>
