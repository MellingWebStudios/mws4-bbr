...
export const metadata: Metadata = {
  ...
  description:
    "Combi boiler repairs in Birmingham. Expert diagnosis of heating and hot water problems. Same-day service, no call-out fee.",
  ...
  openGraph: {
    title: "Combi Boiler Repairs Birmingham | Expert Same Day Fix",
    description: "Combi boiler repairs in Birmingham. Expert diagnosis of heating and hot water problems. Same-day service, no call-out fee.",
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Combi Boiler Repair Service</h1>
