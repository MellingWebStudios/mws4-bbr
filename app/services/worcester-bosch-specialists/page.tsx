...
export const metadata: Metadata = {
  title: "Worcester Bosch Specialists | Birmingham",
  description:
    "Worcester Bosch specialists in Birmingham. Expert repairs & genuine parts. Same-day service, no call-out fee. Call 0800 320 2345!",
  ...
  openGraph: {
    title: "Worcester Bosch Specialists | Birmingham",
    description: "Worcester Bosch specialists in Birmingham. Expert repairs & genuine parts. Same-day service, no call-out fee. Call 0800 320 2345!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Worcester Bosch Boiler Specialists Birmingham - Expert Repairs & Servicing",
      }
    ],
  },
}

export default function WorcesterBoschSpecialistsPage() {
  const service = {
    id: "worcester-bosch",
  ...
  <p>Worcester Bosch boilers can present specific challenges that general heating engineers may not be familiar with. Our specialist knowledge allows us to diagnose and repair Worcester Bosch-specific issues quickly and effectively, saving you time and money.</p>
  
  <p>We stock genuine Worcester Bosch parts and can offer extended warranties on our repair work. Whether you need a simple service, a complex repair, or advice on your Worcester Bosch boiler, our specialist team is here to help.</p>
`,
    pricing: [
      {
      ...
      {
        title: "Worcester Bosch Boiler Repair",
        price: "£80",
        description: "Specialist diagnosis and repair for Worcester Bosch boilers.",
      },
      {
        title: "Worcester Bosch Boiler Service & Repair",
        price: "£110",
    ...
    faqs: [
      {
        question: "Why do I need a Worcester Bosch boiler specialist for my boiler?",
        answer:
          "Worcester Bosch boilers have unique designs and components that require specialist knowledge. Our approved technicians understand Worcester Bosch-specific issues and have access to genuine parts, ensuring more effective and lasting repairs.",
      },
      {
        question: "Do you offer warranties on Worcester Bosch boiler repairs?",
        answer:
          "Yes, we offer extended warranties on our Worcester Bosch boiler repair work, giving you peace of mind that your boiler is protected.",
      },
      {
        question: "Can you service all Worcester Bosch boiler models?",
        answer:
          "Yes, our technicians are trained to service and repair all Worcester Bosch boiler models, from older units to the latest designs.",
      },
      {
        question: "Are your Worcester Bosch boiler parts genuine?",
        answer: "Yes, we only use genuine Worcester Bosch parts to ensure the best performance and longevity of your boiler.",
      },
    ],
  }
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://www.birminghamboilerrepairs.uk/services/worcester-bosch-specialists" />
      </Head>
      <BreadcrumbSchema
        items={[
          { name: "Home", item: "https://www.birminghamboilerrepairs.uk/" },
          { name: "Services", item: "https://www.birminghamboilerrepairs.uk/services" },
          { name: "Worcester Bosch Specialists", item: "https://www.birminghamboilerrepairs.uk/services/worcester-bosch-specialists" },
        ]}
      />
      <FAQSchema faqs={service.faqs} url="https://www.birminghamboilerrepairs.uk/services/worcester-bosch-specialists" />
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-4">
                <Breadcrumb
                  items={[
                    ...
                    { label: "Worcester Bosch Specialists", href: "/services/worcester-bosch-specialists", isCurrent: true },
                  ]}
                />
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Worcester Bosch Boiler Specialists</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-12">
                ...
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div className="p-6">
                      ...
                      <TrackedPhoneLink
                        phone="08003202345"
                        trackingLocation="worcester_bosch_specialists_page"
                        trackingSource="service_info_cta"
                        className="bg-secondary text-white hover:bg-secondary/90 flex items-center gap-2"
                        ariaLabel="Contact a Worcester Bosch Specialist"
                      >
                        <Phone size={16} />
                        Contact a Worcester Bosch Specialist
                      </TrackedPhoneLink>
                    </div>
                  </div>
                </CardContent>
              ...
              {/* Pricing Section */}
              <div>
                <h3 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Worcester Bosch Specialist Pricing</h3>
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
              <div>
                <h3 className="text-3xl font-bold">Need help with your Worcester Bosch boiler?</h3>
