    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Atag Specialists Birmingham - Expert Repairs & Servicing",
      }
    ],
  },
}

export default function AtagSpecialistsPage() {
  const service = {
    id: "atag",
  ...
  <p>Atag boilers can present specific challenges that general heating engineers may not be familiar with. Our specialist knowledge allows us to diagnose and repair Atag-specific issues quickly and effectively, saving you time and money.</p>
  
  <p>We stock genuine Atag parts and can offer extended warranties on our repair work. Whether you need a simple service, a complex repair, or advice on your Atag boiler, our specialist team is here to help.</p>
`,
    pricing: [
      {
    ...
    faqs: [
      {
        question: "Why do I need an Atag specialist for my boiler?",
        answer:
          "Atag boilers have unique designs and components that require specialist knowledge. Our approved technicians understand Atag-specific issues and have access to genuine parts, ensuring more effective and lasting repairs.",
      },
      {
        question: "Do you offer warranties on Atag boiler repairs?",
        answer:
          "Yes, we offer extended warranties on our Atag boiler repair work, giving you peace of mind that your boiler is protected.",
      },
      {
        question: "Can you service all Atag boiler models?",
        answer:
          "Yes, our technicians are trained to service and repair all Atag boiler models, from older units to the latest designs.",
      },
      {
        question: "Are your Atag boiler parts genuine?",
        answer: "Yes, we only use genuine Atag parts to ensure the best performance and longevity of your boiler.",
      },
    ],
  }
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://www.birminghamboilerrepairs.uk/services/atag-specialists" />
      </Head>
      <BreadcrumbSchema
        items={[
          { name: "Home", item: "https://www.birminghamboilerrepairs.uk/" },
          { name: "Services", item: "https://www.birminghamboilerrepairs.uk/services" },
          { name: "Atag Specialists", item: "https://www.birminghamboilerrepairs.uk/services/atag-specialists" },
        ]}
      />
      <FAQSchema faqs={service.faqs} url="https://www.birminghamboilerrepairs.uk/services/atag-specialists" />
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-4">
                <Breadcrumb
                  items={[
                    ...
                    { label: "Atag Specialists", href: "/services/atag-specialists", isCurrent: true },
                  ]}
                />
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Atag Specialists in Birmingham</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-12">
                ...
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    <div className="relative h-64 w-full md:h-auto">
                      <Image
                        src={service.image || "/images/atag_page.webp"}
                        alt={service.title}
                        fill
              ...
              {/* Pricing Section */}
              <div>
                <h3 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Atag Specialist Pricing</h3>
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
              <div>
                <h3 className="text-3xl font-bold">Need help with your Atag boiler?</h3>
