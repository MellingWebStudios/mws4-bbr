    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Glow-worm Specialists Birmingham - Expert Repairs & Servicing",
      }
    ],
  },
}

export default function GlowwormSpecialistsPage() {
  const service = {
    id: "glowworm",
  ...
  <p>Glow-worm boilers can present specific challenges that general heating engineers may not be familiar with. Our specialist knowledge allows us to diagnose and repair Glow-worm-specific issues quickly and effectively, saving you time and money.</p>
  
  <p>We stock genuine Glow-worm parts and can offer extended warranties on our repair work. Whether you need a simple service, a complex repair, or advice on your Glow-worm boiler, our specialist team is here to help.</p>
`,
    pricing: [
      {
      ...
      {
        title: "Glow-worm Boiler Repair",
        price: "£75",
        description: "Specialist diagnosis and repair for Glow-worm boilers.",
      },
      {
        title: "Glow-worm Boiler Service & Repair",
        price: "£99",
    ...
    faqs: [
      {
        question: "Why do I need a Glow-worm specialist for my boiler?",
        answer:
          "Glow-worm boilers have unique designs and components that require specialist knowledge. Our approved technicians understand Glow-worm-specific issues and have access to genuine parts, ensuring more effective and lasting repairs.",
      },
      {
        question: "Do you offer warranties on Glow-worm boiler repairs?",
        answer:
          "Yes, we offer extended warranties on our Glow-worm boiler repair work, giving you peace of mind that your boiler is protected.",
      },
      {
        question: "Can you service all Glow-worm boiler models?",
        answer:
          "Yes, our technicians are trained to service and repair all Glow-worm boiler models, from older units to the latest designs.",
      },
      {
        question: "Are your Glow-worm boiler parts genuine?",
        answer: "Yes, we only use genuine Glow-worm parts to ensure the best performance and longevity of your boiler.",
      },
    ],
  }
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://www.birminghamboilerrepairs.uk/services/glowworm-specialists" />
      </Head>
      <BreadcrumbSchema
        items={[
          { name: "Home", item: "https://www.birminghamboilerrepairs.uk/" },
          { name: "Services", item: "https://www.birminghamboilerrepairs.uk/services" },
          { name: "Glow-worm Specialists", item: "https://www.birminghamboilerrepairs.uk/services/glowworm-specialists" },
        ]}
      />
      <FAQSchema faqs={service.faqs} url="https://www.birminghamboilerrepairs.uk/services/glowworm-specialists" />
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-4">
                <Breadcrumb
                  items={[
                    ...
                    { label: "Glow-worm Specialists", href: "/services/glowworm-specialists", isCurrent: true },
                  ]}
                />
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Glow-worm Specialists in Birmingham</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-12">
                ...
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div className="p-6">
                      ...
                      <TrackedPhoneLink
                        phone="08003202345"
                        trackingLocation="glowworm_specialists_page"
                        trackingSource="service_info_cta"
                        className="bg-secondary text-white hover:bg-secondary/90 flex items-center gap-2"
                        ariaLabel="Contact a Glow-worm Specialist"
                      >
                        <Phone size={16} />
                        Contact a Glow-worm Specialist
                      </TrackedPhoneLink>
                    </div>
                  </div>
                </CardContent>
              ...
              {/* Pricing Section */}
              <div>
                <h2 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Glow-worm Specialist Pricing</h2>
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
              <div>
                <h2 className="text-3xl font-bold">Need help with your Glow-worm boiler?</h2>
