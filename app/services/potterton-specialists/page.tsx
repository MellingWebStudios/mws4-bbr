    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Potterton Specialists Birmingham - Expert Repairs & Servicing",
      }
    ],
  },
}

export default function PottertonSpecialistsPage() {
  const service = {
    id: "potterton",
  ...
  <p>Potterton boilers can present specific challenges that general heating engineers may not be familiar with. Our specialist knowledge allows us to diagnose and repair Potterton-specific issues quickly and effectively, saving you time and money.</p>
  
  <p>We stock genuine Potterton parts and can offer extended warranties on our repair work. Whether you need a simple service, a complex repair, or advice on your Potterton boiler, our specialist team is here to help.</p>
`,
    pricing: [
      {
      ...
      {
        title: "Potterton Boiler Repair",
        price: "£75",
        description: "Specialist diagnosis and repair for Potterton boilers.",
      },
      {
        title: "Potterton Boiler Service & Repair",
        price: "£99",
    ...
    faqs: [
      {
        question: "Why do I need a Potterton specialist for my boiler?",
        answer:
          "Potterton boilers have unique designs and components that require specialist knowledge. Our approved technicians understand Potterton-specific issues and have access to genuine parts, ensuring more effective and lasting repairs.",
      },
      {
        question: "Do you offer warranties on Potterton boiler repairs?",
        answer:
          "Yes, we offer extended warranties on our Potterton boiler repair work, giving you peace of mind that your boiler is protected.",
      },
      {
        question: "Can you service all Potterton boiler models?",
        answer:
          "Yes, our technicians are trained to service and repair all Potterton boiler models, from older units to the latest designs.",
      },
      {
        question: "Are your Potterton boiler parts genuine?",
        answer: "Yes, we only use genuine Potterton parts to ensure the best performance and longevity of your boiler.",
      },
    ],
  }
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://www.birminghamboilerrepairs.uk/services/potterton-specialists" />
      </Head>
      <BreadcrumbSchema
        items={[
          { name: "Home", item: "https://www.birminghamboilerrepairs.uk/" },
          { name: "Services", item: "https://www.birminghamboilerrepairs.uk/services" },
          { name: "Potterton Specialists", item: "https://www.birminghamboilerrepairs.uk/services/potterton-specialists" },
        ]}
      />
      <FAQSchema faqs={service.faqs} url="https://www.birminghamboilerrepairs.uk/services/potterton-specialists" />
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-4">
                <Breadcrumb
                  items={[
                    ...
                    { label: "Potterton Specialists", href: "/services/potterton-specialists", isCurrent: true },
                  ]}
                />
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Potterton Specialists in Birmingham</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-12">
                ...
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div className="p-6">
                      ...
                      <TrackedPhoneLink
                        phone="08003202345"
                        trackingLocation="potterton_specialists_page"
                        trackingSource="service_info_cta"
                        className="bg-secondary text-white hover:bg-secondary/90 flex items-center gap-2"
                        ariaLabel="Contact a Potterton Specialist"
                      >
                        <Phone size={16} />
                        Contact a Potterton Specialist
                      </TrackedPhoneLink>
                    </div>
                  </div>
                </CardContent>
              ...
              {/* Pricing Section */}
              <div>
                <h2 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Potterton Specialist Pricing</h2>
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
              <div>
                <h2 className="text-3xl font-bold">Need help with your Potterton boiler?</h2>
