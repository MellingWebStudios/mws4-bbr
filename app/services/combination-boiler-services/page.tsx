...
export const metadata: Metadata = {
  ...
  description:
    "Combi boiler servicing in Birmingham from £60. Same-day appointments, Gas Safe engineers. Call 0800 320 2345!",
  ...
  openGraph: {
    title: "Combi Boiler Services Birmingham | From £60 | Same Day",
    description: "Combi boiler servicing in Birmingham from £60. Same-day appointments, Gas Safe engineers. Call 0800 320 2345!",
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Combi Boiler Servicing</h1>
