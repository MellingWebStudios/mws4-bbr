    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Ariston Specialists Birmingham - Expert Repairs & Servicing",
      }
    ],
  },
}

export default function AristonSpecialistsPage() {
  const service = {
    id: "ariston",
  ...
  <p>Ariston boilers can present specific challenges that general heating engineers may not be familiar with. Our specialist knowledge allows us to diagnose and repair Ariston-specific issues quickly and effectively, saving you time and money.</p>
  
  <p>We stock genuine Ariston parts and can offer extended warranties on our repair work. Whether you need a simple service, a complex repair, or advice on your Ariston boiler, our specialist team is here to help.</p>
`,
    pricing: [
      {
    ...
    faqs: [
      {
        question: "Why do I need an Ariston specialist for my boiler?",
        answer:
          "Ariston boilers have unique designs and components that require specialist knowledge. Our approved technicians understand Ariston-specific issues and have access to genuine parts, ensuring more effective and lasting repairs.",
      },
      {
        question: "Do you offer warranties on Ariston boiler repairs?",
        answer:
          "Yes, we offer extended warranties on our Ariston boiler repair work, giving you peace of mind that your boiler is protected.",
      },
      {
        question: "Can you service all Ariston boiler models?",
        answer:
          "Yes, our technicians are trained to service and repair all Ariston boiler models, from older units to the latest designs.",
      },
      {
        question: "Are your Ariston boiler parts genuine?",
        answer: "Yes, we only use genuine Ariston parts to ensure the best performance and longevity of your boiler.",
      },
    ],
  }
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://www.birminghamboilerrepairs.uk/services/ariston-specialists" />
      </Head>
      <BreadcrumbSchema
        items={[
          { name: "Home", item: "https://www.birminghamboilerrepairs.uk/" },
          { name: "Services", item: "https://www.birminghamboilerrepairs.uk/services" },
          { name: "Ariston Specialists", item: "https://www.birminghamboilerrepairs.uk/services/ariston-specialists" },
        ]}
      />
      <FAQSchema faqs={service.faqs} url="https://www.birminghamboilerrepairs.uk/services/ariston-specialists" />
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-4">
                <Breadcrumb
                  items={[
                    ...
                    { label: "Ariston Specialists", href: "/services/ariston-specialists", isCurrent: true },
                  ]}
                />
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Ariston Specialists in Birmingham</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-12">
              ...
              {/* Pricing Section */}
              <div>
                <h2 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Ariston Specialist Pricing</h2>
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
              <div>
                <h2 className="text-3xl font-bold">Need help with your Ariston boiler?</h2>
