...
export const metadata: Metadata = {
  ...
  description:
    "Main boiler specialists in Birmingham. Expert repairs & genuine parts. Same-day service, no call-out fee. Call 0800 320 2345!",
  ...
  openGraph: {
    title: "Main Boiler Specialists Birmingham | Same Day Repairs",
    description: "Main boiler specialists in Birmingham. Expert repairs & genuine parts. Same-day service, no call-out fee. Call 0800 320 2345!",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Main Boiler Specialists Birmingham - Expert Repairs & Servicing",
      }
    ],
  },
}

export default function MainBoilerSpecialistsPage() {
  const service = {
    id: "main",
  ...
  <p>Main boilers can present specific challenges that general heating engineers may not be familiar with. Our specialist knowledge allows us to diagnose and repair Main-specific issues quickly and effectively, saving you time and money.</p>
  
  <p>We stock genuine Main parts and can offer extended warranties on our repair work. Whether you need a simple service, a complex repair, or advice on your Main boiler, our specialist team is here to help.</p>
`,
    pricing: [
      {
    ...
    faqs: [
      {
        question: "Why do I need a Main boiler specialist for my boiler?",
        answer:
          "Main boilers have unique designs and components that require specialist knowledge. Our approved technicians understand Main-specific issues and have access to genuine parts, ensuring more effective and lasting repairs.",
      },
      {
        question: "Do you offer warranties on Main boiler repairs?",
        answer:
          "Yes, we offer extended warranties on our Main boiler repair work, giving you peace of mind that your boiler is protected.",
      },
      {
        question: "Can you service all Main boiler models?",
        answer:
          "Yes, our technicians are trained to service and repair all Main boiler models, from older units to the latest designs.",
      },
      {
        question: "Are your Main boiler parts genuine?",
        answer: "Yes, we only use genuine Main parts to ensure the best performance and longevity of your boiler.",
      },
    ],
  }
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://www.birminghamboilerrepairs.uk/services/main-boiler-specialists" />
      </Head>
      <BreadcrumbSchema
        items={[
          { name: "Home", item: "https://www.birminghamboilerrepairs.uk/" },
          { name: "Services", item: "https://www.birminghamboilerrepairs.uk/services" },
          { name: "Main Boiler Specialists", item: "https://www.birminghamboilerrepairs.uk/services/main-boiler-specialists" },
        ]}
      />
      <FAQSchema faqs={service.faqs} url="https://www.birminghamboilerrepairs.uk/services/main-boiler-specialists" />
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mb-4">
                <Breadcrumb
                  items={[
                    ...
                    { label: "Main Boiler Specialists", href: "/services/main-boiler-specialists", isCurrent: true },
                  ]}
                />
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Main Boiler Specialists</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-12">
                ...
                <CardContent className="p-0">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    <div className="p-6">
                      ...
                      <TrackedPhoneLink
                        phone="08003202345"
                        trackingLocation="main_boiler_specialists_page"
                        trackingSource="service_info_cta"
                        className="bg-secondary text-white hover:bg-secondary/90 flex items-center gap-2"
                        ariaLabel="Contact a Main Boiler Specialist"
                      >
                        <Phone size={16} />
                        Contact a Main Boiler Specialist
                      </TrackedPhoneLink>
                    </div>
                  </div>
                </CardContent>
              ...
              {/* Pricing Section */}
              <div>
                <h3 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Main Boiler Specialist Pricing</h3>
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
              <div>
                <h3 className="text-3xl font-bold">Need help with your Main boiler?</h3>
