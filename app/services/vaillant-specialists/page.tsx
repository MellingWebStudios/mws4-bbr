...
export const metadata: Metadata = {
  title: "Vaillant Boiler Specialists | Birmingham",
  description:
    "Vaillant boiler specialists in Birmingham. Expert repairs & genuine parts. Same-day service, no call-out fee. Call 0800 320 2345!",
  ...
  openGraph: {
    title: "Vaillant Boiler Specialists | Birmingham",
    description: "Vaillant boiler specialists in Birmingham. Expert repairs & genuine parts. Same-day service, no call-out fee. Call 0800 320 2345!",
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <h1 className="text-3xl font-bold md:text-4xl lg:text-5xl">Vaillant Boiler Specialists</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-12">
              ...
              {/* Pricing Section */}
              <div>
                <h3 className="mb-6 text-2xl font-bold text-gray-900 dark:text-white">Vaillant Specialist Pricing</h3>
        ...
        <section className="bg-secondary py-16 text-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col items-center justify-between space-y-8 md:flex-row md:space-y-0">
              <div>
                <h3 className="text-3xl font-bold">Need help with your Vaillant boiler?</h3>
